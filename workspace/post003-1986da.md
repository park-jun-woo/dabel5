# 다이슨 스웜의 재료는 어디서 오는가 — 소행성 1986 DA

> Reddit 글 3 초안 (r/IsaacArthur)
> 확정 제목: `Where do you get the metal for a Dyson swarm? There's a 3 km nickel-iron asteroid with our name on it`
> 선행 글: post002-mirror-thermal-runaway.md
> 트리거: "수성이 안 되면 재료는 어디서?" → "여기 있다"
...
The standard Dyson swarm plan starts with "disassemble Mercury." But Mercury has 0.38g surface gravity, 4.25 km/s escape velocity, and 430°C daytime temperatures. That's planetary-scale mining with planetary-scale problems.

Meanwhile, there's a 3 km nickel-iron asteroid (1986 DA) that passes within 0.21 AU of Earth in 2038. Near-zero gravity, Fe-Ni 90%+, and every single component — down to the trace sulfur and phosphorus — has a designated use. Zero waste.

But how do you actually mine a near-zero-gravity metal asteroid, and how do you ship 200,000 tons of ore across the solar system?

Next post: the mining ship, the wire-mesh containers, and the 2038 launch window.
