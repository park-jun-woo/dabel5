...
> Reddit 글 4 초안 (r/IsaacArthur)
> 확정 제목: `How do you mine a zero-gravity metal asteroid and ship 200,000 tons of ore? Here's the design`
> 선행 글: post003-1986da.md
> 트리거: "1986 DA가 좋다는 건 알겠다, 근데 어떻게?"
...
**태양광만으로는 연속 채광 불가.** 그래서 SMR(소형 모듈 원자로, 50~100 kW)이 핵심 에너지원. 근일점 근처에서는 태양광 패널이 부스트로 합류.
...
Next post: the ore arrives. Where do you build, and how does a self-replicating mirror swarm actually grow?
